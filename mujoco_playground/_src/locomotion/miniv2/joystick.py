...
from mujoco_playground._src.locomotion.miniv2.poly_reference_motion import PolyReferenceMotion
from mujoco_playground._src.locomotion.miniv2.rewards import (
...
from mujoco_playground._src.locomotion.miniv2.custom_rewards import reward_imitation
    ...
    def _post_init(self) -> None:
        ...
        if USE_IMITATION_REWARD:
            self.PRM = PolyReferenceMotion(
                constants.ROOT_PATH / "polynomial_coefficients.pkl"
            )
