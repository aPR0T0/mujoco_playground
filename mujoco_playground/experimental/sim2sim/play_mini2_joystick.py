...
from mujoco_playground._src.locomotion.miniv2.base import get_assets
...
class OnnxController:
  """ONNX controller for the miniv2."""
...
def load_callback(model=None, data=None):
  ...
  model = mujoco.MjModel.from_xml_path(
      constants.FLAT_TERRAIN_XML.as_posix(),
      assets=get_assets(),
  )
  ...
  policy = OnnxController(
      policy_path=(_ONNX_DIR / "mini2_policy.onnx").as_posix(),
